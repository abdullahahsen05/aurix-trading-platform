...
export function MetricCard({
  ...
  return (
    <article className="group rounded-lg border border-line bg-panel p-4 shadow-[0_20px_60px_rgba(0,0,0,0.16)] transition duration-200 hover:-translate-y-0.5 hover:border-accent/45">
